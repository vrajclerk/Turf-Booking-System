...
import GetReviews from "../ReviewComponent/GetReviews";
    ...
    const retrieveAllSlots = async () => {
        ...
        useEffect(() => {
            ...
            getGround();
            getAllSlots();
        }, [groundId, retrieveGround]); // Include 'retrieveGround' in the dependency array
                    ...
                    <div className="col-sm-6 mt-2">
                        <div className="card form-card border-color custom-bg">
                            ...
                            <div className="card-body text-left text-color">
                                ...
                                <h4 className="card-text">{ground.description}</h4>

                                <div className="text-left mt-3 h4">
                                ...
                                <div className="text-left mt-3"></div>
                            </div>
                            ...
                            <div className="card-footer custom-bg">
                                ...
                                <div>
                                    <form className="row g-3" onSubmit={bookGround}>
                                        ...
                                        <div className="col-auto">
                                            <label htmlFor="date">Booking Time Slot</label>
                                            <select
                                                name="timeSlot"
                                                onChange={handleBookingInput}
                                                className="form-control"
                                        ...
                                        <div className="d-flex justify-content-center ">
                                            <div>
                                                <input
                                                    type="submit"
                                                    className="btn btn-lg bg-color custom-bg-text mt-3 mb-3"
                                                    value="Book Ground"
                                                />
                                            </div>
                                        </div>
